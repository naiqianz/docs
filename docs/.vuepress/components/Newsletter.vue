<template>
  ...
  <el-form v-if="!form.done" :key="mounted" ref="formRef" :model="form.data" :rules="form.rules" inline @submit.prevent.native="form.submit">
    <el-form-item prop="email" style="width: 220px">
      <el-input v-model="form.data.email" aria-label="Email" type="email" placeholder="example@domain.com"> </el-input>
    </el-form-item>
    <el-form-item>
  ...
  <el-tag v-else type="success" effect="dark">
    <el-icon class="el-icon--left"><i-ep-check /></el-icon>
    Subscribed
  </el-tag>
</template>
